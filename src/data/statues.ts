...
export const famousStatues: FamousStatue[] = [
  ...
  {
    id: 'yakushi-sanzon-yakushiji',
    name: '薬師三尊像',
    temple: '薬師寺 金堂（奈良県奈良市）',
    designation: '国宝',
    era: '奈良時代',
    material: '銅造（金銅仏）',
    tier: 'nyorai',
    note: '中尊の薬師如来を、日光菩薩（向かって右）・月光菩薩（向かって左）が脇侍として囲む薬師三尊の代表例。中尊が左手に薬壺を持つ点が見分けの決め手です。',
  },
  {
    id: 'amida-sanzon-sanzenin',
    name: '阿弥陀三尊像',
    temple: '三千院 往生極楽院（京都府京都市）',
    designation: '国宝',
    era: '平安時代',
    material: '木造・寄木造、漆箔',
    tier: 'nyorai',
    note: '来迎印を結ぶ阿弥陀如来を、観音菩薩・勢至菩薩が脇侍として囲む阿弥陀三尊の代表例。両脇侍が膝を開いて前かがみになる「大和坐り」という珍しい姿勢で、往生者を迎える瞬間を表しています。',
  },
  {
    id: 'hankashi-chuguji',
    name: '菩薩半跏像',
