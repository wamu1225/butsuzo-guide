...
export const representativeBuddhas: RepresentativeBuddha[] = [
  {
    ...
    description:
      '仏教の開祖である釈迦の悟った姿。装飾のない衲衣一枚をまとい、螺髪と肉髻を持つ、如来の基本形。印相は場面によって変わり、説法や安心を与える施無畏印・与願印、瞑想を表す定印などが用いられる。',
  },
  {
    id: 'amida',
    name: '阿弥陀如来',
    ...
    description:
      '西方極楽浄土の教主。来迎印は、死後に極楽浄土から迎えに来る姿を表したもので、阿弥陀如来を見分ける最も分かりやすい手がかりになる。定印を結ぶ像もある。',
  },
  {
    id: 'yakushi',
    name: '薬師如来',
    ...
    description:
      '病や苦しみを癒す如来。左手に薬の入った壺（薬壺）を持つ姿で表されることが多く、他の如来との見分けの決定打になる。',
  },
  {
    id: 'dainichi',
    name: '大日如来',
    ...
    description:
      '密教における宇宙の中心・最高位の仏。実在した釈迦がモデルの如来とは異なり、宇宙そのものを象徴する存在のため、如来でありながら五智宝冠などの装飾をまとう例外的な姿を持つ。金剛界では智拳印を結ぶ。',
  },
  {
    id: 'kannon',
    name: '観音菩薩',
    ...
    description:
      '人々の求めに応じて姿を変え、あらゆる者を漏れなく救うとされる菩薩。十一面観音・千手観音など多くの変化身を持つ。宝冠の正面に小さな阿弥陀如来（化仏）を戴く点が、他の菩薩との見分けの手がかりになる。',
  },
  {
    id: 'jizo',
    name: '地蔵菩薩',
    ...
    description:
      '六道（地獄・餓鬼・畜生・修羅・人・天）を巡り歩き、苦しむ人々を救うとされる菩薩。他の菩薩が持つ宝冠を捨て、僧侶と同じ丸刈りの姿（僧形）をとる点が最大の特徴。右手に錫杖、左手に宝珠を持つことが多い。',
  },
  {
    id: 'fugen',
    name: '普賢菩薩',
    ...
    description:
      '実践や慈悲を象徴する菩薩。六本の牙を持つ白象の背に乗る姿で表され、乗り物の姿そのものが他の菩薩との明確な見分けの手がかりになる。',
  },
  {
    id: 'fudo',
    name: '不動明王',
    ...
    description:
      '明王の中で最も広く信仰される尊格。大日如来の教令を体現し、怒りの姿で人々の迷いを断ち切る。燃え盛る炎（迦楼羅炎）を光背とし、右手に剣、左手に羂索（けんさく・縄）を持つことが多い。',
  },
  {
    id: 'shitenno',
    name: '四天王',
    ...
    description:
      '仏の世界を四方から守る4体の武神（持国天・増長天・広目天・多聞天）。甲冑姿で武器を構え、足元に邪鬼を踏みつける姿は、天部の中でも特に見分けやすい。',
  },
  {
    id: 'kongorikishi',
    name: '金剛力士',
